			    ...
			    <div class="row bg-title">
			     ...
			     <div class="row justify-content-center" style="display: flex; justify-content: center;">
			        <div class="col-md-6 col-sm-8 col-xs-12">
			            <div class="white-box" style="min-height: 220px; margin-top: 30px;">
			                <h3 class="box-title text-primary text-center" style="font-size: 30px;">
							    ${task.name_task}
							</h3>
			                
			                <hr />
			                <p><strong>Dự án:</strong> ${task.project.name}</p>
			                <p><strong>Người quản lý:</strong> ${task.project.manager.fullName}</p>
			                <p><strong>Email quản lý</strong> ${task.project.manager.email}</p>
			                <p><strong>SĐT quản lý:</strong> ${task.project.manager.phone}</p>
			                <p><strong>Ngày bắt đầu:</strong> 
			                    <fmt:formatDate value="${task.startDateSQL}" pattern="dd/MM/yyyy" />
			                </p>
			                <p><strong>Ngày kết thúc:</strong> 
			                    <fmt:formatDate value="${task.endDateSQL}" pattern="dd/MM/yyyy" />
			                </p>
			            </div>
			        </div>
			    </div>
