            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-md-8 col-xs-12">
                        <div class="white-box">
                            <form class="form-horizontal form-material" method="post" action="task-add">
                                <div class="form-group">
                                    <label class="col-md-12">Dự án</label>
                                    <div class="col-md-12">
										<select name="id_project" class="form-control form-control-line">
										    <c:forEach items="${listProjects}" var="p">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input type="text" name = "start_task" placeholder="dd/MM/yyyy"
                                            class="form-control form-control-line"> 
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input type="text" name = "end_task" placeholder="dd/MM/yyyy"
                                            class="form-control form-control-line"> 
                                    </div>
                                </div>
                                <div class="form-group">
