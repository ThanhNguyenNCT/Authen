    										...
    										<c:choose>
										                ...
										                <td>
										                        <select name="id_role" class="form-control form-control-line">
										                            <c:forEach var="r" items="${listRoles}">
										                                <option value="${r.id}" ${r.id == u.roleId ? 'selected' : ''}>${r.name}</option>
										                            </c:forEach>
										                        </select>
										                </td>
										                <td>
										                        ...
										                        <a href="user-table" class="btn btn-default btn-sm">Huỷ</a>
										                    </form>
										                </td>
										            </tr>
										        </c:when>
											  ...
											  <c:otherwise>
											    ...
											    <tr>
											      ...
											      <td>${u.roleName}</td>
											      <td>
					 								<a href="user-table?editId=${u.id}" class="btn btn-sm btn-primary">Sửa</a>
