    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                        ...
                        <div class="white-box">
                            <div class="col-in row">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-6">
                                    <c:set var = "percent" value = "${percentagesByStatus['Chưa hoàn thành']}"></c:set>
									<h3 class="counter text-right m-t-15 text-danger">
										<fmt:formatNumber value="${percent}" maxFractionDigits="2" />%
									</h3>
                                </div>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                        <div class="white-box">
                            <div class="col-in row">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-6">
					    		<c:set var = "percent" value = "${percentagesByStatus['Đang thực hiện']}"></c:set>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                        <div class="white-box">
                            <div class="col-in row">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-6">
					    		<c:set var = "percent" value = "${percentagesByStatus['Đã hoàn thành']}"></c:set>
                ...
                <c:forEach var = "entry" items = "${tasksGrouped}">
	            <div class="row">
                    <div class="col-xs-12">
                        <a href="#" class="group-title">
                            <img width="30" src="plugins/images/users/pawandeep.jpg" class="img-circle" />
                            <!-- entry.key là đối tượng User -->
                            <span>${entry.key.fullName}</span>
                        </a>
                    </div>
                    <div class="col-md-4">
                        <div class="white-box">
                            ...
                            <div class="message-center">
                            	<c:forEach var = "task" items = "${entry.value['Chưa hoàn thành']}">
                                	<a href="#">
                                    	<div class="mail-contnet">
                                    	    <h5>${task.name_task}</h5>
                                    	    <span class="mail-desc"></span>
                                    	    <span class="time">Bắt đầu: <fmt:formatDate value="${task.startDateSQL}" pattern="dd/MM/yyyy" /></span>
            								<span class="time">Kết thúc: <fmt:formatDate value="${task.endDateSQL}" pattern="dd/MM/yyyy" /></span>
                                    	</div>
                                	</a>                            	
                            	</c:forEach>
                            </div>
                    ...
                    <div class="col-md-4">
                        <div class="white-box">
                            ...
                            <div class="message-center">
                            	<c:forEach var = "task" items = "${entry.value['Đang thực hiện']}">
                                	<a href="#">
                                    	<div class="mail-contnet">
                                    	    <h5>${task.name_task}</h5>
                                    	    <span class="mail-desc"></span>
                    ...
                    <div class="col-md-4">
                        <div class="white-box">
                            ...
                            <div class="message-center">
                            	<c:forEach var = "task" items = "${entry.value['Đã hoàn thành']}">
                                	<a href="#">
                                    	<div class="mail-contnet">
                                    	    <h5>${task.name_task}</h5>
                                    	    <span class="mail-desc"></span>
